    ...
    langFields.forEach((lang) => {
        validators.push(
            body(`langs.${lang}.name`)
                .notEmpty()
                .withMessage(`اسم المنتج (${lang}) مطلوب`)
                .isString()
        ...
        validators.push(
            body(`langs.${lang}.description`)
                .notEmpty()
                .withMessage(`الوصف المختصر (${lang}) مطلوب`)
                .isString()
        ...
        validators.push(
            body(`langs.${lang}.details`)
                .notEmpty()
                .withMessage(`تفاصيل المنتج (${lang}) مطلوبة`)
                .isString()
        ...
        validators.push(
            body(`langs.${lang}.seoTitle`)
                .notEmpty()
                .withMessage(`عنوان SEO (${lang}) مطلوب`)
                .isString()
        ...
        validators.push(
            body(`langs.${lang}.seoDescription`)
                .notEmpty()
                .withMessage(`وصف SEO (${lang}) مطلوب`)
                .isString()
